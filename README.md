...
Backend developer based in Lagos, Nigeria. I build APIs, real-time systems, and AI-powered pipelines — and I care about how systems are designed, not just whether they work.

Before backend engineering, I spent 2+ years as a UI/UX designer. That background shapes how I think about developer experience, API contracts, and the people on the other side of the systems I build.

---

## What I work with

**Languages & Frameworks** — Node.js, TypeScript, Express.js, NestJS, Go  
**Databases** — PostgreSQL, MongoDB, Supabase  
**AI & Automation** — Gemini API, OpenAI API, n8n, Google Search Grounding  
...
**[Company Mention Monitor](https://github.com/zainabwahab-eth/fluna-take-home-zainab)**  
Full-stack AI pipeline that monitors company mentions in cleantech news. Supabase Edge Function → n8n → Gemini 2.5 Flash → PostgreSQL. Built with duplicate handling, quality scoring, and multi-level error handling.
...
[LinkedIn](https://www.linkedin.com/in/zainab-wahab-8280ba326) · [Email](mailto:zainabwahab.eth@gmail.com)
